...
import ChangelogAdmin from "@/components/changelog/ChangelogAdmin";
...
const Changelog = () => {
  ...
  useEffect(() => {
    const fetchFromDB = async () => {
      ...
      if (!dbEntries?.length) return; // fallback to static
    ...
    fetchFromDB();
  }, [showAdmin]); // refetch when admin panel closes
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          {isAdmin && (
            ...
            >
              ...
              {showAdmin ? "View Changelog" : "Manage"}
            </Button>
          )}
        </div>
